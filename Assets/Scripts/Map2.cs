...
public class ScriptMap2 : MonoBehaviour
{
    ...
    private static List<List<int>> ListOfNeighbours = Map2Neighbours.ListOfNeighbours;
    ...
    void AutoPopulate()
    {
        ...
        for (int i = 0; i < listOfColors.Count; i++)
        {
            ...
            TextMeshProUGUI numberTroopsText = GameObject.Find($"country{i + 1}map2").GetComponentInChildren<TextMeshProUGUI>();
    ...
    void Start()
    {
        ...
        {
            //gets the button
            Button button = GameObject.Find($"country{i}map2").GetComponent<Button>();
